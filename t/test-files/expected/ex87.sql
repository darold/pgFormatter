...
FROM (
    ...
    FROM
        ...
        LEFT OUTER JOIN db1.v_table3 librarystat2 ON librarystat2.column1 = library.column1) AS price;
...
FROM (
    ...
    FROM
        ...
        LEFT JOIN t3 c ON c.a = a.a) AS x;
...
FROM (
    ...
    FROM (
        ...
        FROM
            library a
            RIGHT OUTER JOIN t3 b ON b.c1 = a.c1) y) z;
...
FROM (
    ...
    FROM (
        ...
        FROM
            base) AS s
    LEFT OUTER JOIN t3 st ON st.c1 = s.c1) AS o;
