...
INSERT INTO test_jsonb
    VALUES ('scalar', '"a scalar"'), ('array', '["zero", "one","two",null,"four","five", [1,2,3],{"f1":9}]'), ('object', '{"field1":"val1","field2":"val2","field3":null, "field4": 4, "field5": [1,2,3], "field6": {"f1":9}}');
...
SELECT
    jsonb_contained ('{"a":"b", "c":null}',
        '{"a":"b", "b":1, "c":null}');

SELECT
    jsonb_contained ('{"a":"b", "g":null}',
        '{"a":"b", "b":1, "c":null}');

SELECT
    jsonb_contained ('{"g":null}',
        '{"a":"b", "b":1, "c":null}');
...
-- null key error
SELECT
    jsonb_object ('{a,b,NULL,"d e f"}',
        '{1,2,3,"a b c"}');

-- empty key is allowed
SELECT
    jsonb_object ('{a,b,"","d e f"}',
        '{1,2,3,"a b c"}');
...
SELECT
    jsonb_delete ('{"a":1 , "b":2, "c":3}'::jsonb,
        'a');

SELECT
    jsonb_delete ('{"a":null , "b":2, "c":3}'::jsonb,
        'a');
...
SELECT
    jsonb_delete_path ('{"n":null, "a":1, "b":[1,2], "c":{"1":2}, "d":{"1":[2,3]}}',
        '{n}');
