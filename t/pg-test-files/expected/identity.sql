...
CREATE TABLE itest_err_1 (
    a text GENERATED BY DEFAULT AS IDENTITY
);
...
CREATE TABLE itest_err_3 (
    a int DEFAULT 5 GENERATED BY DEFAULT AS IDENTITY
);

-- cannot combine serial and identity
CREATE TABLE itest_err_4 (
    a serial GENERATED BY DEFAULT AS IDENTITY
);
...
INSERT INTO itest6 DEFAULT VALUES; ALTER TABLE itest6
    ALTER COLUMN a SET GENERATED BY DEFAULT SET INCREMENT BY 2 SET START WITH 100 RESTART;
...
ALTER TABLE itest7
    ALTER COLUMN a SET GENERATED BY DEFAULT;
