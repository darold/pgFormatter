...
# Verify the option also reaches the formatter through public configuration paths.
...
SQL
	'configuration-file alignment preserves default function spacing'
);
...
SQL
	'CGI forwards alignment while preserving default function spacing'
);
