...
5 10 10 15 15 20 20 25.CREATE OR REPLACE VIEW viewtest AS
SELECT
    *
FROM
    viewtest_tbl;
...
CREATE SCHEMA temp_view_test CREATE TABLE base_table (
    a int,
    id int)
...
-- should fail
CREATE SCHEMA test_view_schema CREATE TEMP VIEW testview AS
SELECT
    1;
