...
X0F X10 X1F X11 X2F X12 X3F X13 X8F X04 X000F X0010 X0123 XFFFF X2468 X2468 XFA50 X05AF X1234 XFFF5.
SELECT
    a,
    b,
    ~ a AS "~ a",
...
X0F00 X1000 X1F00 X1100 X2F00 X1200 X3F00 X1300 X8F00 X0400 X000F X0010 X0123 XFFFF X2468 X2468 XFA50 X05AF X1234 XFFF5.
SELECT
    a,
    b,
    ~ a AS "~ a",
...
\d bit_defaults
INSERT INTO bit_defaults DEFAULT
    VALUES
;
