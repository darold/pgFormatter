...
INSERT INTO inhe
    VALUES ('ee-col1', 'ee-col2', DEFAULT, 'ee-col4');
...
CREATE TABLE test_like_id_2 (
    LIKE test_like_id_1
);

\d test_like_id_2
INSERT INTO test_like_id_2 (b)
    VALUES ('b2');
...
CREATE TABLE test_like_id_3 (
    LIKE test_like_id_1 INCLUDING IDENTITY
);

\d test_like_id_3
INSERT INTO test_like_id_3 (b)
    VALUES ('b3');
...
CREATE TABLE test_like_gen_1 (
    a int,
    b int GENERATED ALWAYS AS (a * 2) STORED
);

\d test_like_gen_1
INSERT INTO test_like_gen_1 (a)
    VALUES (1);
...
CREATE TABLE test_like_gen_2 (
    LIKE test_like_gen_1
);

\d test_like_gen_2
INSERT INTO test_like_gen_2 (a)
    VALUES (1);
...
CREATE TABLE test_like_gen_3 (
    LIKE test_like_gen_1 INCLUDING GENERATED
);

\d test_like_gen_3
INSERT INTO test_like_gen_3 (a)
    VALUES (1);
...
CREATE TABLE ctlt1 (
    a text CHECK (length(a) > 2) PRIMARY KEY,
    b text
);
...
CREATE TABLE ctlt_all (
    LIKE ctlt1 INCLUDING ALL
);
...
CREATE TABLE ctlt11a (
    LIKE ctlv1 INCLUDING ALL
);

CREATE TYPE ctlty1 AS (
    a int,
    b text
);
