...
When formatted content starts on a new line after an opening parenthesis,
put the matching closing parenthesis on its own line, aligned with the opening
line. Disabled by default; applies to text output.
